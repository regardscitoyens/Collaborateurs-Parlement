...
missing='\(Éliane Assassi","ASSASSI","Eliane","F","Mme COLLIOT Géraldine\|Joseph Castelli","CASTELLI","Joseph","H","M. CASTELLI Cyrille\|Patrick Chaize","CHAIZE","Patrick","H","Mme ROPOSTE Léa\)'
